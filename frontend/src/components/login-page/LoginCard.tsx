    ...
    return (
        <div className="login-card">
            ...
            <div className="social-login-buttons">
                <button className="social-btn google-btn" onClick={() => alert("Chức năng Google đang phát triển")}>
                ...
                <button className="social-btn facebook-btn" onClick={() => alert("Chức năng Facebook đang phát triển")}>
